...
public class PigToProtobuf {
  ...
  public static <M extends Message> M tupleToMessage(Class<M> protoClass, Tuple tuple) {
    Builder builder = (Builder) Protobufs.getMessageBuilder(protoClass);
      ...
      if (tupleField != null) {
        if (fieldDescriptor.isRepeated()) {
          ...
          if (fieldDescriptor.getType() == FieldDescriptor.Type.MESSAGE) {
            Builder nestedMessageBuilder = (Builder) builder.newBuilderForField(fieldDescriptor);
   ...
   */
  private static List<Object> dataBagToRepeatedField(Message.Builder containingMessageBuilder, FieldDescriptor fieldDescriptor, DataBag bag) {
    ...
    while (bagIter.hasNext()) {
      ...
      if (fieldDescriptor.getType() == FieldDescriptor.Type.MESSAGE) {
        Builder nestedMessageBuilder = (Builder) containingMessageBuilder.newBuilderForField(fieldDescriptor);
